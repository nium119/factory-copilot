...
│   ├── backend/
│   └── frontend/
└── factory-copilot/      # Agent 平台 (端口 9004)
    ├── backend/
    └── frontend/
```
...
# 验证
curl -s http://localhost:9004/api/chains/compile/status
```
...
| 服务 | 端口 | 说明 |
|------|------|------|
| Factory Copilot API | 9004 | Agent 对话和配置 |
| Factory Copilot 前端 | 5004 | 开发模式（nginx 代理到 9004） |
...
2. 打开 Factory Copilot (9004)，顶部选择本体图谱
