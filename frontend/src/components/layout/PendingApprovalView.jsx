...
import { Button, Spin, Empty, message, Tag, Popconfirm, Input, Tabs } from 'antd';
    ...
    return (
      <div key={item.id} style={{
        ...
        {(item.param_schema || []).length > 0 ? (
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px 16px', fontSize: 12, color: '#666', background: '#fafafa', padding: '8px 12px', borderRadius: 4 }}>
